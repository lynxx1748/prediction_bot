...
class TestAIStrategy(unittest.TestCase):
    ...
    def test_initialize_model(self, mock_dump, mock_load, mock_exists):
        ...
        mock_load.return_value = (mock_model, MagicMock(), ['bullRatio', 'bearRatio', 'bnb_change', 'btc_change'])
    ...
    def test_predict(self, mock_config):
        ...
        mock_model = MagicMock()
        mock_model.predict_proba.return_value = np.array([[0.4, 0.6]])  # 60% confidence in BULL
