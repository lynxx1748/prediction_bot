...
class TestHybridPrediction(unittest.TestCase):
    ...
    def test_hybrid_prediction_bullish(self, mock_record, mock_config, mock_detect_pattern):
    ...
    @patch('models.func_hybrid.config')
    @patch('models.func_hybrid.record_prediction')
    def test_hybrid_prediction_bearish(self, mock_record, mock_config, mock_detect_pattern):
    ...
    @patch('models.func_hybrid.config')
    @patch('models.func_hybrid.record_prediction')
    def test_hybrid_prediction_error_handling(self, mock_record, mock_config, mock_detect_pattern):
