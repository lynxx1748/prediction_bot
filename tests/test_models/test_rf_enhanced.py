...
class TestAdaptiveRandomForest(unittest.TestCase):
    ...
    def setUp(self, mock_config):
        ...
        mock_config.get.return_value = {
            "parameters": {"n_estimators": 10, "max_depth": 3, "min_samples_split": 2},
            "min_samples": 20,
            "recency_weight": True,
        ...
        with patch("models.func_rf_enhanced.ModelEvaluator"), patch(
            "models.func_rf_enhanced.ModelVersionControl"
    ...
    def test_train_and_predict(self, mock_joblib):
        ...
        bull_pred, bull_conf = self.model.predict(
            {"bullRatio": 0.8, "bearRatio": 0.2, "bnb_change": 1.0, "btc_change": 1.5}
        )
        ...
        bear_pred, bear_conf = self.model.predict(
            {"bullRatio": 0.2, "bearRatio": 0.8, "bnb_change": -1.0, "btc_change": -1.5}
        )
